import pygame
from config import WINDOW_WIDTH, WINDOW_HEIGHT, BLACK, WHITE, DELAY, RUTA_IMAGEN_BLANCO, RUTA_IMAGEN_ELMO, RUTA_IMAGEN_RANA, RUTA_IMAGEN_PIGGY, RUTA_IMAGEN_GALLETA, RUTA_IMAGEN_PIGGY_LOVE, RUTA_IMAGEN_TRIO, RUTA_IMAGEN_PIGGY_RANA, RUTA_IMAGEN_ELMO_RANA
...
galleta = Personaje("Galleta", RUTA_IMAGEN_GALLETA, (3,3))
